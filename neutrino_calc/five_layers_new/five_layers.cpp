...
int main()
{
    ...
    array<array<double, number_of_energies>, number_of_angles> p11;
    array<array<double, number_of_energies>, number_of_angles> p12;
    array<array<double, number_of_energies>, number_of_angles> p21;
    array<array<double, number_of_energies>, number_of_angles> p22;
    ...
    for (int angle_index = 0; angle_index < number_of_angles; angle_index++)
    {
        ...
        if (b < r[4])
        {
            ...
            for (int energy_index = 0; energy_index < number_of_energies; energy_index++)
            {
                ...
                for (int i = 0; i <= 4; i++)
                {
                    Matrix_1 << cos(theta_m(energies[energy_index], l[i], v[i])), sin(theta_m(energies[energy_index], l[i], v[i])),
                        -sin(theta_m(energies[energy_index], l[i], v[i])), cos(theta_m(energies[energy_index], l[i], v[i]));
                    Matrix_2 << complex<double>(cos(0.5 * phi(energies[energy_index], l[i], v[i])), sin(0.5 * phi(energies[energy_index], l[i], v[i]))), 0,
                        0, complex<double>(cos(0.5 * phi(energies[energy_index], l[i], v[i])), -sin(0.5 * phi(energies[energy_index], l[i], v[i])));
                ...
                p11[angle_index][energy_index] = pow(abs(S1(0, 0)), 2) + S2_00_sqr;
                p12[angle_index][energy_index] = pow(abs(S1(0, 1)), 2) + S2_01_sqr;
                p21[angle_index][energy_index] = pow(abs(S1(1, 0)), 2) + S2_01_sqr;
                p22[angle_index][energy_index] = pow(abs(S1(1, 1)), 2) + S2_11_sqr;
            }
        }
        else if (b < r[3])
        {
        ...
        else
        {
            ...
            for (int energy_index = 0; energy_index < number_of_energies; energy_index++)
            {
                ...
                Matrix_2 << complex<double>(cos(0.5 * phi(energies[energy_index], l, v[0])), sin(0.5 * phi(energies[energy_index], l, v[0]))), 0,
                    0, complex<double>(cos(0.5 * phi(energies[energy_index], l, v[0])), -sin(0.5 * phi(energies[energy_index], l, v[0])));
                Matrix_3 = Matrix_1.transpose();
                A = A * Matrix_1;
                A = A * Matrix_2;
                A = A * Matrix_3;
    ...
    fstream fout;
    fout.open("delta_05pi_p12.csv", ios::out);
    {
        ...
        for (int angle_index = 0; angle_index < number_of_angles; angle_index++)
        {
            for (int energy_index = 0; energy_index < number_of_energies; energy_index++)
            {
                ...
                fout << p12[angle_index][energy_index] << "\n";
            }
