...
int main()
{
    ...
    StandardModel *standard_model = new StandardModel(earth_model, neutrino_potensials, 50, 950, 1, 180);
    standard_model->SaveToFile("std_files/delta_pi_p_00.txt", "p_00");
    standard_model->SaveToFile("std_files/delta_pi_p_01.txt", "p_01");
    standard_model->SaveToFile("std_files/delta_pi_p_10.txt", "p_10");
    standard_model->SaveToFile("std_files/delta_pi_p_11.txt", "p_11");
